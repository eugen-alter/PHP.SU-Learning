 ...
 * ErrorController
 */ 
class ErrorController extends GM_Controller_Base
{ 
    function init()
    {
        parent::init();
    ...
    { 
        ...
        if( $errors->exception instanceof Vertus_Exception_PageNotFound)
        {
            $this->getResponse()->setHttpResponseCode(404);
            $this->view->message = 'Страница не найдена';
        }
        ...
        $this->log( $errors->exception->__toString(), Zend_Log::INFO);
    } 
}
